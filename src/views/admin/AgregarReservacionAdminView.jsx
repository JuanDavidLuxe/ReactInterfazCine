...
export const AgregarReservacionAdminView = ({ setReservacion }) => {
...
console.log("CLIENTE ACCEDIDO: ", clientesObte);
console.log("ASIENTOSOBTE: ", asientosObte)
console.log("PROYECCIONOBTE: ", proyeccionesObte)
  ...
  return (
    <>
      <h1>AGREGAR RESERVACION ADMIN</h1>
